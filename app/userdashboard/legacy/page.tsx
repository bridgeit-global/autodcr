...
import DraftApplicationsModal, { DraftApplication } from "@/app/components/DraftApplicationsModal";
...
function UserDashboardContent() {
  ...
  return (
    <div className="h-full w-full overflow-hidden bg-surface p-4 md:p-6">
      <div className="flex h-full w-full flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        <div className="min-h-0 flex-1 overflow-y-auto bg-gray-50 p-4 md:p-6">
          {/* Mandatory notice */}
          <div className="mb-4 rounded-md border-l-4 border-red-500 bg-red-50 p-4 shadow-sm">
          ...
          {/* Main Content */}
          <div className="flex min-h-full gap-4 overflow-x-hidden">
            {/* Left Content Area */}
